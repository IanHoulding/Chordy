...
[
 ...
 "Various common text manipulation commands are available via buttons and/or text boxes.\n",
 "<s Chords (top left)> ",
 "A series of buttons that let you insert chords (in ChorPro format) into the text area.\n",
 "<s Directives (middle left)> ",
 "A set of buttons that insert <I Directives> into the text area.\n",
 "<s Counters & Goto (bottom left)> ",
 ...
 "<O MOe:s: Font Size>",
 "<O MOe:s: Font Colour>",
 "<O MOe:s: Editor Background>",
 "<V2>",
 "<O MOc:s: Chord Colour>",
 "<O MOc:s: Chord Size>",
 "<O MOc:s: Chord Offset>",
 "<V2>",
 "<O MOd:s: Directive Colour>",
 "<O MOd:s: DIrective Size>",
 "<V5>",
 ...
 "<O CM:h:   Text Operations   >",
 "<V5>",
 "<X Undo> <O UD:s:Undo>",
 "<V3>",
 "<X Redo> <O RD:s:Redo>",
 "<V3>",
 "<X settags> <O TS:s:Reformat Buffer>",
 "<V3>",
 "<X chordU> <X chordD> <O Cu:s:Move Chord Up/Down>",
 "<V3>",
 "<X chordL> <X chordR> <O Cl:s:Move Chord Left/Right>",
 "<V3>",
 "<X Find> <O FD:s:Find>",
 "<V3>",
 "<X FindNext> <O FN:s:Find Next>",
 "<V3>",
 "<X FindPrev> <O FP:s:Find Prev>",
 "<V3>",
 "<X checkbox> <O IC:s:Ignore Case>",

]);
    if (OS ne 'aqua') {
      $win->add([
	"<V3>",
	"<X Replace> <O FR:s:Find & Replace>",
	"<V3>",
	"<X ReplaceAll> <O RA:s:Find & Replace All>",
		]);
    }
...
######
 ...
 "<V5>",
"<T Mof><s Open\n>",
 "<M>Pops up a window for you to select a file for editing.",
 "<V2>",
 "<T Mfs><s New\n>",
 "<M>Prompts for the name of a new file - does not need an extension.",
 "<V2>",
 "<T Mnc><s Close\n>",
 ...
 "<V2>",
 "<T MEt><s Text to ChordPro\n>",
 "<M>This entry converts text in the edit window with chords above the lyrics into ChordPro format ie. with the chords surrounded by <B [> <B ]> and in front of the relevant lyric. There are a number of sites on the WEB that provide lyrics in this format and this saves an awful lot of tedious typing!",
 "<V5>",
 ...
 "<T MOe><s Editor Background\n>",
 "<M>Lets you define the background colour of the text area.",
 "<V1>",
 "<T MOc><s Chord Colour\n>",
 "<M>Changes the colour of all Chords displayed in the edit area (including the brackets).",
 "<T MOc><s Chord Size\n>",
 "<M>Changes the size that Chords are displayed at.",
 "<T MOc><s Chord Offset\n>",
 "<M>Because of the way text baselines are handled, Chords can appear below or above the lyric text baseline. This option allows you to adjust the Chord baseline",
 "<V1>",
 "<T MOd><s Directive Colour\n>",
 "<M>Changes the colour of all Directives displayed in the edit area.\n",
 "<T MOd><s Directive Size\n>",
...
"<T Mha><s About\n>",
 ...
 "<M>Removes all formatting from the text area and then reformats it from start to end.",
 "<V5>",
 "<T Cu><X chordU> <X chordD><s  Move chord Up/Down> ",
 "<M>Place the cursor on a chord definition and it will be highlighted. Clicking these buttons will move the whole chord definition Up or Down one line.",
 "<V5>",
 "<T Cl><X chordL> <X chordR><s  Move chord Left/Right> ",
 "<M>As with the Up and Down buttons (see above), the chord definition will move Left or Right one character. Hitting the start or end of a line will move the chord to the previous/next line.",
 "<V5>",
 "<T FD><X Find> <s Find> ",
...
[
 ...
 "<T SC><s {sov|start_of_verse}> ",
  ...
  "<M>These now follow the standard ChordPro directive in that you can follow the directive with any text which then forms a <B Label> which can be used in subsequent {verse}, {chorus} or {bridge} directives: {sov:Verse 1} --> {verse:Verse 1}",
 "<M>This is useful where (in this example) the first verse is later repeated.",
 "<M>Another use for the <B Label> is when the <B Show Labels> option is enabled. The <B Label> will be printed above the associated section with a background colour that is a dark version of the secion background.\n",
 ...
 "<c A|--------|-------4|-4---424|-4---424|> ",
 "<c E|--------|--------|--------|--------|> \n",
 "<M>As with the equivalent verse/chorus/bridge directives, the {sot} one can be followed with a text argument so that future {tab:xxxx} directives can repeat a previously defined tab section.",
 ...
 "<M>As indicated above, this directive can have a text argument after the directive ie: {chorus:Chorus 2}. If Chordy detects there are no lines of lyrics defined which match the text argument it will act as if you had just specified {verse}, {chorus}, {bridge} or {tab}.",
 "<M>A side issue is that a plain directive will repeat the <I last> {soX}/{eoX} section defined.\n",
