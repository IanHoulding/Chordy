...
# "<O To:H: Table Of Contents >",
 ...
 "<O Mhb:s: Highlight Border>",
 "<O Moc:s: Comment Full Line>",
 "<O Mcb:s: Comment Border>",
 "<V1>",
...
######
 ...
 "<V2>",
 "<T Mhb><s Highlight Border\n>",
 "<M>Highlighted text can optionally have a 1point coloured border placed around it.",
 "<V2>",
 "<T Moc><s Comment Full Line\n>",
 "<M>Same as for Highlight above.",
 "<V2>",
 "<T Mcb><s Comment Border\n>",
 "<M>Same as for Highlight above.",
 "<V5>",
