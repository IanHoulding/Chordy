...
#####################
 ...
 "<V 5><E>",
 "<T Ch> <P  Header > ",
 "<M>Copies anything which is <I not> a Note.",
 "<V 5><E>",
 "<T Cn> <P  Notes > ",
 "<M>Copies only Notes",
 "<V 5><E>",
 "<T Ca> <P  All > ",
 "<M>Copies EVERYTHING - Notes, Voltas, Headings etc.",
 "<V 5><E>",
 "<T Co> <P  Over > ",
 "<M>Any Bars in the Copy Buffer will overwrite any page Bars starting at the selected Bar.",
 "<V 5><E>",
 "<T Cb> <P  Before > ",
